...
class DenseNet121(nn.Module):
    ...
    def __init__(self, classCount, isTrained):
        ...
        try:
            weights = torchvision.models.DenseNet121_Weights.DEFAULT if isTrained else None
...
class DenseNet169(nn.Module):
    ...
    def __init__(self, classCount, isTrained):
        ...
        try:
            weights = torchvision.models.DenseNet169_Weights.DEFAULT if isTrained else None
            self.densenet169 = torchvision.models.densenet169(weights=weights)
        except AttributeError:
...
class DenseNet201(nn.Module):
    ...
    def __init__ (self, classCount, isTrained):
        ...
        try:
            weights = torchvision.models.DenseNet201_Weights.DEFAULT if isTrained else None
            self.densenet201 = torchvision.models.densenet201(weights=weights)
        except AttributeError:
